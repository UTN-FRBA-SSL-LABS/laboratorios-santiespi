...
> R: Pone la cantidad de productos del carrito en 0 y se llama antes de usarlo para que el carrito empiece vacio y no tenga un valor de cantidad cualquiera
...
> R: No, dio 350 y se esperaba 700
...
> R: En la linea 24, que le suma al total el precio de los items

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R: Deberia multiplicar por cantidad
...
> R: Si, las lineas 29 y 30 tienen ##### porque esa funcion no se ejecuto en los tests unitarios, solamente en el test de integracion
...
> R: El unitario prueba una funcion por separado y el de integracion varias juntas, el bug de carrito_total lo encontro primero el unitario
...
> R: Porque en C se puede escribir fuera del array y tocar memoria que no corresponde, en Python o Java eso se controla
...
> R: Porque los tests prueban automaticamente si el resultado es el esperado y ayudan a encontrar errores
...
> R: Porque con cantidad 1 sumar solo el precio da lo mismo que multiplicarlo por 1, con cantidad 2 ya se nota el error
